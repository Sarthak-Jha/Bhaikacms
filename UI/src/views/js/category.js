    ...
    methods:{
        ...
        nodeWasClicked(nodeChild){
          ...
          submit(){
            ...
            this.$http.post("http://localhost:8081/admin/addCategory?categoryName="+this.addCategory.categoryName+"&parentName="+this.addCategory.parentName)
          ...
          deleteCategory(){
            ...
            this.$http.delete("http://localhost:8081/admin/deleteCategory?categoryId="+this.addCategory.categoryId)
            .then(response => response.json())
            .then(response => {
              if(response){
                this.refreshPage()
          ...
          editCategory(){
            ...
            this.$http.put("http://localhost:8081/admin/updateCategory?categoryName="+this.addCategory.parentName+"&newName="+this.addCategory.newName)
            .then(response => response.json())
            .then(response => {
